...
void delay_ms(uint32_t time) //time degerine mesela 10 atadýk sistem her 1ms de SysTick_Handler fonk gidecek
{
	delay_counter = time;
...
void TIM_Config()
{
	...
	/* PWM_FREQ = 10KHz olmasýný istedik 10000mhz
	 *
	 * tim_tic = 84000000 / (psc+1) = 1000000 , psc = 83
	 *
	 * periyod = (1000000 / 1000=PWM_FREQ)-1 = 99
	 **/
	...
	SysTick_Config(SystemCoreClock/1000); //1ms de bir kesmeye girer.//LEDLERIN yanma hizini ayarlamak istiyorsak burandan ayarlama yapmaliyiz
